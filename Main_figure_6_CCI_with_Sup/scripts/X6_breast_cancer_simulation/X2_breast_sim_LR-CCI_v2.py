...
spatial_data = spatial_data[:,[gene for gene in spatial_data.var_names if '_' not in gene]].copy()
...
spatial_data.write_h5ad(out_dir+'spatialsim_LRCCI.h5ad', compression='gzip')
