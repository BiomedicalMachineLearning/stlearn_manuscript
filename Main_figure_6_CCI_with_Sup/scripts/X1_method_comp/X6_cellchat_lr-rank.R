# Examining the LR results from CellChat, in
...
print(length(st_lrs)) # 549
print(length(cc_intersect)) # 549
...
print(top_intersect) # 27 overlap, that seems quite reasonable !!!!!!!
